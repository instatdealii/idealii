...
namespace spacetime{
	...
	public:
		...
		typename dealii::FEValuesViews::Scalar<dim>::value_type
			scalar_value(const typename dealii::FEValuesExtractors::Scalar& extractor,unsigned int function_no, unsigned int point_no);
		 ...
		 */
		typename dealii::FEValuesViews::Scalar<dim>::value_type
			scalar_dt(const typename dealii::FEValuesExtractors::Scalar& extractor,unsigned int function_no, unsigned int point_no);
		/**
		...
		typename dealii::FEValuesViews::Scalar<dim>::gradient_type
			scalar_space_grad(const typename dealii::FEValuesExtractors::Scalar& extractor,unsigned int function_no, unsigned int point_no);
		...
		typename dealii::FEValuesViews::Vector<dim>::value_type
			vector_value(const typename dealii::FEValuesExtractors::Vector& extractor,unsigned int function_no, unsigned int point_no);
		 ...
		 */
		typename dealii::FEValuesViews::Vector<dim>::value_type
			vector_dt(const typename dealii::FEValuesExtractors::Vector& extractor,unsigned int function_no, unsigned int point_no);
		...
		typename dealii::FEValuesViews::Vector<dim>::divergence_type
			vector_divergence(const typename dealii::FEValuesExtractors::Vector& extractor,unsigned int function_no, unsigned int point_no);
		...
		typename dealii::FEValuesViews::Vector<dim>::gradient_type
			vector_space_grad(const typename dealii::FEValuesExtractors::Vector& extractor,unsigned int function_no, unsigned int point_no);
		...
		typename dealii::FEValuesViews::Vector<dim>::curl_type
			vector_space_curl(const typename dealii::FEValuesExtractors::Vector& extractor,unsigned int function_no, unsigned int point_no);
	...
	public:
		 ...
		 */
		typename dealii::FEValuesViews::Scalar<dim>::value_type
			scalar_value_minus(const typename dealii::FEValuesExtractors::Scalar& extractor,
					         unsigned int function_no,
							 unsigned int point_no);
