...
namespace internal{
	...
	void upwind_temporal_pattern(
		...
		if(dof.fe_support_type()==spacetime::DG_FiniteElement<dim>::support_type::Lobatto){
	...
	make_hanging_node_constraints(
		...
		dealii::DoFTools::make_hanging_node_constraints(*dof_handler.spatial(),*space_constraints);
    ...
    dealii::IndexSet extract_locally_relevant_dofs(slab::DoFHandler<dim>& dof_handler){
		dealii::IndexSet space_relevant_dofs;
	    dealii::DoFTools::extract_locally_relevant_dofs(*dof_handler.spatial(),space_relevant_dofs);
